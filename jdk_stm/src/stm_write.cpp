...
{
    unsigned short i, j, crc_accum = 0, data_blk_size = data_blk_ptr.size();
    ...
    divideByte(data_blk_ptr, crc_accum, 2);
}

void StmPacketGenerator::writePacket(vector<uint8_t> &packet)
{
